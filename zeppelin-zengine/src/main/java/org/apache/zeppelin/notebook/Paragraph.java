 ...
 *
 * Derived from zeppelin-zengine/src/main/java/org/apache/zeppelin/notebook/Paragraph.java
 * of Apache Zeppelin project
 *
...
public class Paragraph extends Job implements Serializable, Cloneable {
  ...
  protected Object jobRun() throws Throwable {
    ...
    InterpretLoop:
      while (true) {
        ret = repl.interpret(script, context);
        String message = "";
        ...
        if (message.isEmpty()) {
          ...
          if (interpreterResultMessage != null && !interpreterResultMessage.isEmpty()) {
            ...
            ret = new InterpreterResult(ret.code(), ret.type(), message);
          } else {
            ret = new InterpreterResult(ret.code(), outputType, message);
          }
        }
