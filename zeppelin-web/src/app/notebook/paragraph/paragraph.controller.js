...
angular.module('zeppelinWebApp')
  ...
  $scope.getExecutionTime = function() {
    ...
    var desc = 'Took ' +
      moment.duration(moment(pdata.dateFinished).diff(moment(pdata.dateStarted))).asSeconds() +
      ' second(s). Last updated by ' + user + ' at ' + moment(pdata.dateUpdated).format('MMMM DD YYYY, h:mm:ss A') + '.';
    if ($scope.isResultOutdated()){
      desc += ' (outdated)';
    }
    return desc;
